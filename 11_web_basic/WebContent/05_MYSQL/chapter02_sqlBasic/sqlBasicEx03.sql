...
INSERT INTO PRODUCT
VALUES 		('P10001','모니터받침대',8000,NOW());

INSERT INTO 
		PRODUCT
VALUES 		('P10002','게임마우스패드',25000,NOW());
...
VALUES
		('P10005' , '기계식키보드 화이트(적축)' , 38000);

INSERT INTO
		PRODUCT (PRODUCT_CD , PRODUCT_NM , PRICE , REG_DT)
VALUES
		('P10006' , '먼지제거제' , 5000 , NOW());
...
SELECT * FROM PRODUCT;
	...
	# 트랜잭션 제어 언어 (Transaction Control Language) // onchange
